...
const stickySections = ()=>{
    ...
    pourquoiChoisir.style.top = `calc(${headerHeight + navSectionsHeight}px + 2rem)`;
};
const navScrollTo = ()=>{
    ...
    sections.forEach((section)=>{
        ...
        } else document.querySelector(`.nav-link[href="#${id}"]`).classList.remove("active");
    });
};
const navClickTo = ()=>{
    navLinks.forEach((link)=>{
...
},{"../scss/style.scss":"kxOFu"}],"kxOFu":[function() {},{}]},["3qbGD","lFcwH"], "lFcwH", "parcelRequire8fee")
